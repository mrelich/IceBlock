...
//const G4double m_n    = 2;           // index of refraction for ice                  
//const G4double m_nAir = 1.000293;       // index of refraction for air
const G4double m_nAir = 1.000;       // index of refraction for air
